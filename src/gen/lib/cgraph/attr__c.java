...
public static ST_Agrec_s agmakeattrs(ST_Agraph_s context, ST_Agobj_s obj) {
...
try {
    ...
    ST_Agsym_s sym;
    ST_dt_s datadict;
    rec = (ST_Agattr_s) agbindrec(obj, AgDataRecName, sizeof(ST_Agattr_s.class), false);
...
public static CFunction addattr = new CFunctionAbstract("addattr") {
	...
	public Object exe(Object... args) {
		addattr((ST_Agraph_s)args[0], (ST_Agobj_s)args[1], (ST_Agsym_s)args[2]);
		return null;
	}};
@Reviewed(when = "12/11/2020")
@Difficult
...
try {
	...
	if (psym!=null) {		/* new local definition */
	    ...
	    switch (kind) {
	    case AGRAPH:
		agapply(root, root.base, attr__c.addattr,
			rsym, true);
		break;
	    case AGNODE:
...
public static int agxset(ST_Agobj_s obj, ST_Agsym_s sym, CString value) {
...
public static int agsafeset(ST_Agobj_s obj, CString name, CString value, CString def) {
